            ...
            for video in files:
                if video.endswith(self.vid_types):
                    ...
                    try:
                        ...
                        self.prompt_amount =abs(video_len// self.prompt_length)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--prompt_length', help="The average length of a prompt in frames", type=int, default=300)
